...
layui.define(["lay", "layer", "util"], function (e) {
    "use strict";
    var b = layui.$, y = layui.layer, d = layui.util, l = layui.hint(), w = (layui.device(), "form"), o = ".layui-form",
        T = "layui-this", $ = "layui-hide", q = "layui-disabled", t = function () {
            this.config = {
                ...
                }, verIncludelRequired: !1, autocomplete: null
            }
            ...
            return !(e = b(e))[0] || (e.attr("lay-verify") !== undefined || !1 !== this.validate(e.find("*[lay-verify]"))) && (layui.each(e, function (e, r) {
                ...
                if (s.removeClass(h), layui.each(t, function (e, t) {
                    ...
                    if (a) {
                        ...
                        if ("required" === t && (i = s.attr("lay-reqtext") || i), n && (d.verIncludelRequired || "required" === t || c && "required" !== t)) return "tips" === o ? y.tips(i, "string" != typeof s.attr("lay-ignore") && l ? s.next() : s, {tips: 1}) : "alert" === o ? y.alert(i, {
                            title: "\u63d0\u793a",
                            shadeClose: !0
...
layui.define(["lay", "laytpl", "laypage", "form", "util"], function (e) {
    ...
    var p = layui.$, c = layui.lay, m = layui.laytpl, O = layui.laypage, f = layui.layer, v = layui.form,
        ...
        I = p(window), F = p(document), n = function (e) {
            ...
            var t, i, l = this, n = l.config, o = "layui-table-click",
                d = l.layBody.find("tr" + ("all" === a.index ? "" : '[data-index="' + a.index + '"]'));
            "checkbox" !== (a = p.extend({type: "checkbox"}, a)).type && "all" !== a.index && d.addClass(o).siblings("tr").removeClass(o), a.selectedStyle || e || (o = x.cache[l.key], t = "checked" in a, i = function (e) {
            ...
            var n = this.config, e = x.cache[this.key];
            ...
            var s = this, u = s.config, c = u.elem.attr("lay-filter"), e = s.layHeader.find("th"), y = ".layui-table-cell",
                o = p("body"), d = {}, r = (s.layTool.on("click", "*[lay-event]", function (e) {
                    ...
                    var t = p(this), a = t.closest("td"), t = t.prev(), i = s.layBody.find('input[name="layTableCheckbox"]'),
                        l = t.parents("tr").eq(0).data("index"), n = t[0].checked,
                    ...
                    var t = ".layui-form-checkbox,.layui-form-radio,[lay-unrow]", a = p(this).find(t);
...
layui.define(["table"], function (e) {
    "use strict";
    var B = layui.$, h = layui.form, j = layui.table, f = layui.hint(), P = {
        ...
        m = "layui-table-tree", H = "LAY_DATA_INDEX", x = "LAY_DATA_INDEX_HISTORY", s = "LAY_PARENT_INDEX",
        b = "LAY_CHECKBOX_HALF", X = "LAY_EXPAND", z = "LAY_HAS_EXPANDED", V = "LAY_ASYNC_STATUS", t = function (e) {
            var t = this;
    ...
    var n, U = function (e, t, a) {
        ...
        if (x) if (m) b.nextAll(v.map(function (e, t, a) {
            ...
            if (b.enable && y[s] && !y[V]) {
                ...
                var _ = B.extend({}, b.where || o.where), T = b.autoParam, T = (layui.each(T, function (e, t) {
                    ...
                    S = b.dataType || o.dataType, O = b.jsonpCallback || o.jsonpCallback, w = b.headers || o.headers,
        ...
        var t = F(a);
        if (t) {
            var n = t.getOptions(), i = n.tree, l = n.elem.next(), r = i.customName.isParent;
            if (e) {
                e = P.getData(a, !0);
                if (i["async"].enable) {
                    var d = !0;
        ...
        var n = this, i = n.getOptions(), l = i.elem.next(), r = (l.hasClass(m) || l.addClass(m), i.id),
            d = i.tree || {}, o = (d.data, d.view || {}), c = d.customName || {}, u = c.isParent,
            f = l.attr("lay-filter"), s = n,
        ...
        if (p) return f = p.getOptions(), s = f.tree, a = f.elem.next(), y = (t = t || {}).parentIndex, i = t.index, l = t.data, t = t.focus, n = (y = "number" === layui.type(y) ? y.toString() : y) ? p.getNodeDataByIndex(y) : null, i = "number" === layui.type(i) ? i : -1, l = B.extend(!0, [], layui.isArray(l) ? l : [l]), p.getTableData(), n ? (r = s.customName.isParent, s = s.customName.children, n[r] = !0, u = (u = n[s]) ? (d = u.splice(-1 === i ? u.length : i), n[s] = u.concat(l, d)) : n[s] = l, p.updateStatus(u, function (e) {
            ...
            return 'tr[lay-data-index="' + e[H] + '"]'
        }).join(",")).remove(), p.initData(), n[z] = !1, n[V] = "local", J({trElem: a.find('tr[lay-data-index="' + y + '"]')}, !0)) : (d = j.cache[e].splice(-1 === i ? j.cache[e].length : i), j.cache[e] = j.cache[e].concat(l, d), f.url || (f.page ? (u = f.page, f.data.splice.apply(f.data, [u.limit * (u.curr - 1), u.limit].concat(j.cache[e]))) : f.data = j.cache[e]), p.initData(), s = j.getTrHtml(e, l), o = {
            trs: B(s.trs.join("")),
        ...
        t.id;
        a.hasClass(m) && (r(e), (t.tree || {}).view.dblClickExpand && J({trElem: e.tr.first()}, null, null, null, !0))
        ...
        e.elem = _(e.elem), e.elem[0] && layui.each(e.elem.get().reverse(), function (e, a) {
            var t, l, i, o, n, s, c, d, r, u, y = _(a),
                E = _.extend(!0, {}, M, lay.options(a), (t = {}, layui.each(["title", "height", "encode", "skin", "about"], function (e, a) {
                    ...
                    i.push(x(this.value))
                }), 0 === i.length && i.push(x(y.html())), i), f = (y.data("code", p), {
                    copy: {
                        className: "file-b",
                        title: ["\u590d\u5236\u4ee3\u7801"],
                        event: function (e, a) {
