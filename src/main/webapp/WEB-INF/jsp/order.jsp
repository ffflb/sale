        ...
        <div class="layui-card-body">
            ...
            <form class="layui-form layui-form-pane" id="my-form" >
              <div class="layui-form-item">
                <label class="layui-form-label" style="width: 180px">请输入待查询订单名称:</label>
...
<script>
  ...
  layui.use('table', function(){
    ...
    $('#delBatchOrder').click(function(){
      ...
      $.ajax({
        url: '${pageContext.request.contextPath}/order/delBatchOrder?'+ids,
        type: "get",
  ...
  layui.use(['form'], function () {
    ...
    form.on('submit(demo1)', function (data) {
      ...
      $.ajax({
        url: '${pageContext.request.contextPath}/order/toOrder',
        type: "post",
        data: {orderName},
        success: function () {
            LoadIndex("${pageContext.request.contextPath}/order/toOrder?orderName="+orderName)
          layer.msg('搜索成功');
        },
        error: function () {
          layer.msg('搜索失败');
